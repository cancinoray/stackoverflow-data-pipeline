...
def transform_2012(df):
    # Selecting relevant columns from the 2012 dataset
    df_2012_raw = df.select(
        ...
        "_c23", "_c24", "_c25", "_c26", "_c27", "_c28", "_c29", "_c30",
        ...
        "_c45", "_c46", "_c47", "_c48", "_c49", "_c50", "_c51", "_c52", "_c53", "_c54",
    ...
    # Concatenating the columns for technology products
    # List all the relevant columns
    columns = [
        "Which technology products do you own? (You can choose more than one)",
        "_c45",
